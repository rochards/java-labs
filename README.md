# Java Labs: Small Java Experiments and Learning Projects

`java-labs` is a collection of small Java projects where I test ideas, build examples, and explore specific technologies in a practical way.
...
- `java-httpclient`: This repository is a learning lab for understanding how Java `HttpClient` works in practice, with examples and tests covering successful calls, non-`200` responses, timeouts, connection failures, resets, and HTTPS/TLS certificate handling. See the project README in [`java-httpclient/README.md`](./java-httpclient/README.md).
